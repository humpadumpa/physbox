 ...
 * @author Per Eresund
 */
public class PlatformWorld<E extends PlatformEntity> extends World {
	...
	public PlatformWorld(int width, int height, double gravity, double friction) {
		super(width, height);
	...
	@Override
	protected Grid<PlatformEntity> grid() { return (Grid<PlatformEntity>)super.grid(); };
...
//	private final boolean 
	...
	private final double roundTime = 30, period = 0;
